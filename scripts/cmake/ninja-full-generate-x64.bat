...
Kissaki:   The build docs say you can manually enable a unity build for compilation speedup.
           It does not say why it's not a default or why one would not use that though?
